        ...
        <div className={`flex flex-col space-y-1.5 ${containerClassName}`}>
            ...
            <input
                ...
                className={`
                    ...
                    focus:outline-none focus:ring-4 focus:ring-secondary/20 focus:border-primary
                    disabled:bg-gray-50 disabled:text-text-muted dark:disabled:bg-gray-800
                    ${error ? 'border-red-300 focus:border-red-500 focus:ring-red-100' : 'border-gray-200 hover:border-primary/40 dark:border-gray-700 dark:hover:border-gray-600'}
                    ${className}
                `}
                {...props}
            />
