        ...
        <div className="min-h-screen bg-background-light flex flex-col font-body">
            ...
            <section className="pt-20 pb-10 sm:pb-14 lg:pt-28 lg:pb-20 xl:pb-24 px-4 sm:px-6 lg:px-12 xl:px-20 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24 overflow-hidden">
                ...
                <div className="lg:w-1/2 relative w-full max-w-lg lg:max-w-none">
                    ...
                    <div className="w-full h-[500px] rounded-[2.5rem] shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-700 ease-out overflow-hidden border-4 border-white dark:border-white/5">
                        <img
                            src={doctorsHero}
                            alt="MedSync Doctor"
